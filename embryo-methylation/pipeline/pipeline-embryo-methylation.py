...
# rm -r /hpc/users/torred23/pipelines/projects/early-embryo/arion/methylation/s04-methylation.dir
...
# @transform('arion/methylation/s03-bismark.dir/{organism}/results/*/methylation/*.CpG_report.txt.gz',
# 		   regex(r'(.*).suffix'),
